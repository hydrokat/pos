    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li><a href="">Old Sales</a></li>
          </ul>
          <ul class="nav nav-sidebar">
            <li><a href="">Daily Reports</a></li>
            <li><a href="">Ending Inventory</a></li>
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Inventory Report</a>
                <ul class="dropdown-menu" role="menu">
                    <li><a href="">Rice</a></li>
                    <li><a href="">Feeds</a></li>
                    <li><a href="">By Products</a></li>
                    <li><a href="">Veterinaries</a></li>
                </ul>
            </li>
          </ul>
          <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Sample Report</h2>
